...
ALTER TABLE `attendance_audit_logs` ADD CONSTRAINT `attendance_audit_logs_attendance_record_id_attendance_records_id_fk` FOREIGN KEY (`attendance_record_id`) REFERENCES `attendance_records`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
