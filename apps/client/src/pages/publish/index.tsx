...
export default function WorkspacePage() {
  ...
  if (!state.currentUser.capabilities.canManageProjects) return <PageShell eyebrow="ACCESS" title="没有工作台权限" subtitle="工作台仅对具有管理能力的用户显示。"><View className="empty-state"><Text className="empty-title">请切换到 Admin Mock User</Text><Text className="empty-copy">在“我的”页面可以切换开发角色。</Text></View></PageShell>
